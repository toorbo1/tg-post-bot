...
- **Pollinations.ai** для создания пиксельных городов в формате 4:3 (работает без ключа!)
...
**Изображения:** Работают через Pollinations.ai — **без ключа, бесплатно!**

### 2. Настрой .env файл:

Открой `.env` в корне проекта:
